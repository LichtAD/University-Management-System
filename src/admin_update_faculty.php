		...
		<div class="div_deg">
            ...
            <form action="#" method="POST">
                ...
                <!-- <div>
                    ...
                    <input type="radio" name="dept" value="<?php echo "{$info['f_dept']}"; ?>" >CSE
                    <input type="radio" name="dept" value="<?php echo "{$info['f_dept']}"; ?>" >EEE
                    <input type="radio" name="dept" value="<?php echo "{$info['f_dept']}"; ?>" >BBA
                    <input type="radio" name="dept" value="<?php echo "{$info['f_dept']}"; ?>" >ENG
                    <input type="radio" name="dept" value="<?php echo "{$info['f_dept']}"; ?>" >ARC
                </div> -->
